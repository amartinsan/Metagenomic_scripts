...
# Create QIIME2 export directory
...
out <- filterAndTrim(fnFs, filtFs,
                   trimRight=36,
                   minLen=200,  # Adjust based on your read quality
                   maxEE=3,
                   truncQ=3,
                   rm.phix=TRUE,
                   compress=TRUE,
...
tic("Create Basic Phyloseq Object")
...
# Save basic phyloseq object
save(ps_basic, mab2join, file=file.path(path, "bacfile.rda"))
toc(log = TRUE)
